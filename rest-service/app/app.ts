...
import { FabricDAO } from "./blockchain";
...
class App {
  ...
  private enrollUsers(): App {
    FabricDAO.enrollAdmin(); 
    FabricDAO.registerUser();
    return this;
  }
  ...
  private setRoutes(): App {
    ...
    this.express
      .use('/api/v1/welcome', welcomeRoutes)
      .use('/api/v1/records', medicalRecordRoutes)
      .use('/', baseRoutes);
    return this;
  }
