...
function networkDown () {
  ...
  if [ "$MODE" != "restart" ]; then
    ...
    rm -rf channel-artifacts/*.block channel-artifacts/*.tx crypto-config ./org3-artifacts/crypto-config/ channel-artifacts/org3.json ./org4-artifacts/crypto-config/ channel-artifacts/org4.json ./org5-artifacts/crypto-config/ channel-artifacts/org5.json
